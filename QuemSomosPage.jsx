  ...
  return (
    <div className="container" style={{ paddingTop: '40px' }}>
      <section id="acamar-uvr-destino" className="info-section">
        ...
        <p>
          O Programa Coleta Amiga foi instituído através da <a href="http://leismunicipa.is/dnozx" target="_blank" rel="noopener noreferrer">Lei Municipal n° 3250 em 03 de maio de 2022</a>. Seus principais objetivos são:
        </p>
        <ul>
      ...
      <section className="info-section">
        ...
        <p>
          Neste local, a <strong>Associação de Catadores de Materiais Recicláveis (ACAMAR)</strong> realiza a triagem, prensagem e disponibilização dos recicláveis para as indústrias, que irão transformar esses materiais em novos produtos de consumo.
        </p>
        <img src="/imagens/foto-acamar-uvr.jpg" alt="Foto da fachada da Unidade de Valorização de Recicláveis (UVR) de Assis Chateaubriand." width="800" height="533" loading="lazy" />
      </section>
    </div>
  );
}
